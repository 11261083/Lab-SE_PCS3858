...
const char* mqttUser = "Bus"; //"TccTagoIO"; // Replace with your TagoIO token
const char* mqttPassword = "0837b686-ab2b-4b83-b318-61220fb35b55"; //"862b7c31-7caf-4420-8dfd-2cca33c6f587"; 
...
void loop()
 {
  ...
  String payload_s = "[{\"id\": \"4\",\"linha\": \"8012\",\"tempo\": \"11:00\"}]";
  const char* payload = (payload_s).c_str();

  MQTT.publish("Bus/test", payload);
  delay(10000);
}